 ...
 * @author Hiep
 */
public class Movielens100K extends Dataset {
    ...
    public Movielens100K(int iFold) {
        if (iFold != 6) {
            RATING_PATH = DIR_PATH + "ml-100K\\u" + Integer.toString(iFold) + ".base";
            TESTING_PATH = DIR_PATH + "ml-100K\\u" + Integer.toString(iFold) + ".test";
        } else {
            RATING_PATH = DIR_PATH + "ml-100K\\ua.base";
            TESTING_PATH = DIR_PATH + "ml-100K\\ua.test";
        }
    }
